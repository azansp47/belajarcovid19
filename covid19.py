...
app.layout = html.Div(
    html.Div([
        ...
        html.Div(
            [
                html.H1(children='Data real time covid 19',
                        style={
                            'textAlign': 'left',
                            'color': colors['text'],
                ...
                html.Div([html.Span('Dasbor: Wabah Covid-19. (Diperbarui sekali sehari, berdasarkan total hari terakhir konsolidasi) Terakhir Diperbarui: ',
                ...
                html.Div([html.Span('Data covid dimulai dari 22-Jan-2020: ',
                             style={'color': colors['text'],
                             }),
                ...
                html.Div(children='Tampilan data covid 19, refresh browser untuk melihat update terakhir',
                         style={
                             'textAlign': 'left',
                             'color': colors['text'],
                             'backgroundColor': colors['background'],
        ...
        html.Div([
            html.Div([
                ...
                html.P('Peningkatan 24 jam terakhir: +' + f"{df_confirmed_total[-1] - df_confirmed_total[-2]:,d}"
        ...
        html.Div(
            [
                html.H4(children='Kasus Covid 19 Skala Global',
                         style={
                             'textAlign': 'center',
                             'color': colors['text'],
                             'backgroundColor': colors['background'],
                ...
                html.Div([
                    dcc.RadioItems(
                        ...
                        options=[{'label': i, 'value': i}
                                 for i in ['Total Kasus', 'Kasus Harian']],
                        value='Total Cases',
                    ...
                    dcc.RadioItems(
                        ...
                        options=[{'label': i, 'value': i}
                                 for i in ['Kasus Diterima', 'Kasus Kematian']],
        ...
        html.Div([
            html.Div([
                    ...
                    html.P([html.Span('Negara dengan kasus tertinggi: ',
                             ),
                    html.Br(),
            ...
            html.Div([
                    html.P([html.Span('Kasus tertinggi perhari: ',
                             ),
                    html.Br(),
                    html.Span(' + 24 jam terakhir',
                             style={'color': colors['confirmed_text'],
            ...
            html.Div([
                    html.P([html.Span('Negara dengan kematian tertinggi: ',
                             ),
                    html.Br(),
                    html.Span(' + 24 jam terkahir (Tingkat Kematian)',
                             style={'color': '#f2786f',
                             'fontWeight': 'bold','fontSize': 14,})
                    ],
                    style={
            ...
            html.Div([
                    ...
                    html.P([html.Span('Kematian tertinggi perhari: ',
                             ),
                    html.Br(),
                    html.Span(' + 24 jam terakhir (Tingkat Kematian)',
                             style={'color': '#f2786f',
                             'fontWeight': 'bold','fontSize': 14,})
                    ],
                    style={
        ...
        html.Div([
            html.Div(children='Peta Wabah Global',
                     style={
                         'textAlign': 'center',
                         'color': colors['text'],
                         'backgroundColor': colors['background'],
                ...
                html.Div(
                    [
                        dt.DataTable(
                            ...
                            columns=[
                                {"name": i, "id": i, "deletable": False, "selectable": True} for i in ['Provinsi', 'Negara', 'Diterima',
                                                                                                       'Meninggal', 'Sembuh']
                            ],
